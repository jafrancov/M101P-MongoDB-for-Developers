...
# Answer: For this homework, make sure it's running the blog (python blog.py),
# in another terminal session run: python validate.py
# That will give the validation code
